...
export function twitterFilterFixture() {
  return `<!doctype html><html><head><meta charset="utf-8">
    ...
    <script>
      ...
      let settingsWatcher, secretsWatcher;
      ...
      window.resolvePost = (i,blocked,classifier='claude-haiku') => requests[i].callback({
      ...
      window.makeCell = (id,text) => {
        ...
        cell.innerHTML='<article data-testid="tweet"><a href="/fixture/status/'+id+'"><time>1m</time></a><div data-testid="tweetText" id="text-'+id+'"></div><span id="counter-'+id+'">1 like</span></article>';
